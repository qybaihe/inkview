#!/usr/bin/env python3
"""Slice a green-screen ink component sheet into transparent PNG assets."""
...
def main() -> None:
    ...
    cell_w = sheet.width // args.columns
    ...
    for row in rows:
        ...
        crop = sheet.crop((col * cell_w, row_index * cell_h, (col + 1) * cell_w, (row_index + 1) * cell_h))
