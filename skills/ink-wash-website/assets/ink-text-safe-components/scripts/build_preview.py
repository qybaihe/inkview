#!/usr/bin/env python3
"""Build a preview image for the text-safe ink component library."""
...
def main() -> None:
    ...
    draw.text((24, 22), f"Ink Text-Safe Components - {len(rows)} Component Preview", fill="#f6f2e9", font=title_font)
