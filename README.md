...
InkView is a portable agent skill and asset library for redesigning websites into a tasteful ink-wash / guofeng visual language. It bundles a 176-icon transparent PNG library, reusable design prompts, CSS tokens, and adapters for Codex, Cursor, Claude Code, and generic AI coding agents.
...
### 3. Give your agent the transformation brief
...
5. Copy selected icons into the target project's own asset directory.
6. Replace or add icons only where they improve clarity or atmosphere.
7. Verify mobile and desktop layout, text contrast, and icon paths.
